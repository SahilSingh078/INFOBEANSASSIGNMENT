...
while True:
    ...
    print("3. Comapare Main and Secondary Diagonal Sums")
    print("4. Exit")
    choice = int(input("Enter Your choice: "))
    match choice:
      case 1:
         print("======Display Main Diagonal Elements======")
         r1 = int(input("enter the number of rows: "))
         c1 = int(input("Enter the cnumber of columns: "))
         A= []
         for i in range(r1):
            row = []
            for j in range(c1):
               row.append(int(input(f"Enter the values {i+1}: ")))
            A.append(row)
         print("matrix is: ")
         print(*A)
         for i in range(r1):
            n = A[i][i]
            print("Display Main Diagonal Elements: ",n)
      case 2:
          print("======Display Secondary Diagonal Elements======")
          r1 = int(input("enter the number of rows: "))
          ...
          for i in range(r1):
             for j in range((c1-1),-1,-1):
               n = A[i][j]
               print("Display secondary Diagonal Elements: ",n)
               c1=c1-1
               break
      case 3:
